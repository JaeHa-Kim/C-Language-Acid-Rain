...
# 전체적인 흐름
메모장에 입력한 단어를 리스트로 만들고, 매 스테이지마다 단어장 리스트에서 30개 정도의 단어를 랜덤으로 뽑아 해당 스테이지에서 사용하게 됩니다.<br>
단어는 랜덤하게 선정되어 떨어지게 됩니다.<br>
구조체를 만들어 생성된 개별 단어들을 식별하고 좌표를 관리합니다. 설정한 주기마다 단어의 좌표를 바꿔줍니다. y좌표를 변경함으로써 단어가 떨어지는 듯이 보이게 됩니다.<br>
단어가 바닥으로 내려왔을 때, 단어를 삭제하고 목숨이 감소합니다. 목숨이 0이 되면 게임오버가 됩니다.<br>
